                                ...
                                ?>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <?php $id = $result->userID; ?>
                                                <td>

                                                    <a href="edit_user.php?pid=<?php echo htmlentities($result->userID); ?>"><span class="btn btn-success">Edit</span>
                                                    <a href="manage_user.php?del=<?php echo htmlentities($result->userID);?>"><button class="btn btn-danger" type="button">Delete</button></a></td>
                                                </td>
                                            </tr>
