                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="edit_booking.php?pid=<?php echo htmlentities($result->bID); ?>"><span class="btn btn-success">Edit</span>
                                                    <a href="manage_bookings.php?del=<?php echo htmlentities($result->bID);?>"><button class="btn btn-danger" type="button">Delete</button></a></td>
                                                </td>
                                            </tr>
